...
GOAL_FIELDS = (
    ...
    "direct_action_override_enabled",
...
MOTOR_TELEMETRY_FIELDS = (
    ...
    "walking_drive_spikes",
    "steering_threshold_hz",
    "forward_hz",
    "forward_left_hz",
    "forward_right_hz",
    "steering_spikes",
    ...
    try:
        for index in range(1, steps + 1):
            ...
            observations.append(
                {
                    ...
                    "raw_brain_action": state.get("raw_brain_action") or state.get("decision_action"),
                    ...
                    "total_active_seconds": state.get("total_active_seconds"),
            ...
            print(
                ...
                "raw_action=", state.get("raw_brain_action") or state.get("decision_action") or state["last_action"],
                "applied_action=", state.get("applied_action") or state["last_action"],
                "override=", state.get("action_overridden", False),
