...
existing 20 ms stimulation budget into ten short pulses across the 50 ms neural
decision window (about 200 Hz) while keeping the same 20-current amplitude. The
