...
existing 20 ms stimulation budget into eight short pulses across the 50 ms neural
decision window (about 160 Hz) while keeping the same 20-current amplitude. The
